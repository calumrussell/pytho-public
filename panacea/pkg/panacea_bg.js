...
* @returns {any}
*/
export function backtest(js_input) {
    const ret = wasm.backtest(addHeapObject(js_input));
...
* @returns {any}
*/
export function antevorta(js_input) {
    const ret = wasm.antevorta(addHeapObject(js_input));
    return takeObject(ret);
}
...
* @returns {any}
*/
export function drawdown(js_input) {
    const ret = wasm.drawdown(addHeapObject(js_input));
    return takeObject(ret);
}
...
* @returns {any}
*/
export function risk(js_input) {
    const ret = wasm.risk(addHeapObject(js_input));
    return takeObject(ret);
}
