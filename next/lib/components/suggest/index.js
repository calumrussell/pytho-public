...
export { useSuggest, SuggestProvider } from "./reducers/suggest";

import { useSuggest } from "./reducers/suggest";
...
export const AutoSuggest = ({
  ...
  const { state, clearOptions, updateInput, selectValue } = useSuggest();
  ...
  const onInputChange = (e, { newValue }) => updateInput(newValue);
